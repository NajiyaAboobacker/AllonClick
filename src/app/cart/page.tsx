...
export default function CartPage() {
  ...
  return (
    <div style={{ padding: '20px' }}>
        ...
        >
          ...
          <div>
            ...
            <button
              ...
              style={{ marginTop: '10px', color: 'white', backgroundColor: 'red', padding: '6px 12px', border: 'none', borderRadius: '4px' }}
            >
              Remove
            </button>
          </div>
      ...
      <hr />
      <h4 className='text-primary'>Total: ${totalAmount.toFixed(2)}</h4>
